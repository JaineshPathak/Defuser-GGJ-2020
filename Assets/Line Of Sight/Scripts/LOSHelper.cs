...
namespace LOS
{
    ...
    public static class LOSHelper
    {
        ...
        /// <summary>
        /// Checks if the mesh bounds are visible to the LOS Source Cube
        /// </summary>
        public static bool CheckBoundsVisibility(LOSSourceCube losSourceCube, Bounds meshBounds, int layerMask)
        {
            ...
            if (losSourceCube.IsVisible && currentCamera != null)
            {
                ...
                {
                    if (LOSHelper.CheckRayCast(currentCamera, meshBounds, losSourceCube.SourceInfo.w, layerMask))
                    {
                        return true;
                    }
                }
