...
namespace LOS
{
    ...
    public class LOSBufferStorage : MonoBehaviour
    {
        ...
        private void OnEnable()
        {
            ...
            enabled &= Assert.Verify(SystemInfo.supportsRenderTextures, "System does not support render textures");
            enabled &= Assert.Verify(SystemInfo.supportsImageEffects, "System does not support image effects");
        }
